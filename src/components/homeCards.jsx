    ...
    <>
      <section className="home-card-section ">
        <div className="container mx-auto">
          ...
          <div className="home-cards-parent grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-6 mt-8 mb-8">
            <div className="border ">
              <img src={Card1} alt="" className="w-full" />
              <h3 className="text-black text-[20px] font-Roboto font-medium  p-2">
                Residential Plumbing
              </h3>
              <p className="text-[#545454] text-[16px] font-Roboto font-light p-2 h-[100px] overflow-auto">
                A residential plumbing system can be succinctly described by
                focusing on two essential components: the water supply line and
                the drainage line.{" "}
              </p>
              <Link
                to="/"
            ...
            <div className="border ">
              ...
              <p className="text-[#545454] text-[16px] font-Roboto font-light p-2 h-[100px] overflow-auto">
                Drain cleaning involves the removal of clogs and blockages in
                pipes to ensure proper water flow and prevent backups.
              </p>
              <Link
                to="/"
                className="inline-flex justify-start gap-2 text-customBlue-light p-2 hover:animate-bounce"
